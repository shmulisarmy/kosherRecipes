...
def root():
    ...
    <main>
        <div style="padding: 10px; border: solid 1px blue;" class="card">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat maxime autem quas laboriosam, libero dolores maiores. Nihil, aliquid? Quas blanditiis voluptates rerum sed magni aut est natus suscipit modi aspernatur.</p>
        </div>
    </main>
